 ...
 */
public class FinishedBacklogEvent implements SourceEvent {
    private static final long serialVersionUID = 1L;

    private final TableBucket tableBucket;

    public FinishedBacklogEvent(TableBucket tableBucket) {
    ...
    public boolean equals(Object o) {
        ...
        FinishedBacklogEvent that = (FinishedBacklogEvent) o;
    ...
    public String toString() {
        return "FinishedBacklogEvent{" + "tableBucket=" + tableBucket + '}';
    }
}
